...
/**
 *  almost the same like PlayListDetailTabCtrl
 * */
public class MyListDetailTabCtrl  extends {
  ...
  public MyListDetailTabCtrl(String title,PlayList playList, PlayerCtrl playerCtrl,IProvider provider,HomeTabPaneCtrl homeTabPaneCtrl) {
    ...
    playListBtn = new Button("",new ImageView(new Image(MyListDetailTabCtrl.class.getResource("/assets/play.png").toString())));
    addAll2QueuqBtn = new Button("",new ImageView(new Image(MyListDetailTabCtrl.class.getResource("/assets/add.png").toString())));
    saveListBtn = new Button("",new ImageView(new Image(MyListDetailTabCtrl.class.getResource("/assets/edit.png").toString())));
    openLinkBtn = new Button("",new ImageView(new Image(MyListDetailTabCtrl.class.getResource("/assets/del.png").toString())));
    tab  = new Tab(title);
    init();
  }
              ...
              public TableCell call(final TableColumn<Track, String> param) {
                ...
                cell.addEventFilter(MouseEvent.MOUSE_CLICKED, event ->{
                  if (event.getEventType() ==MouseEvent.MOUSE_CLICKED) {
                    ...
                    MyListDetailTabCtrl myListDetailTabCtrl = new MyListDetailTabCtrl("专辑详情",playList,playerCtrl,provider,homeTabPaneCtrl);
                    Tab playListDetailTab = myListDetailTabCtrl.getTab();
